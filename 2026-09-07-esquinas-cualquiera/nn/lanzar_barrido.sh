#!/usr/bin/env sh
# El barrido de `esq-cq`, lanzado como UNIDAD de systemd. Y como preguntarle.
#
...
node \"\$COORD_HOME/scripts/notify.mjs\" 'esq-cq: barrido terminado (5 brazos x $EPOCAS epocas). Resultados en nn/pesos/*/metrics.jsonl y muestras/*-ep$EPOCAS.png' || true"
