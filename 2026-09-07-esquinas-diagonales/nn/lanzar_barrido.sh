#!/usr/bin/env sh
# El barrido de `esq-2d`, lanzado como UNIDAD de systemd. Y como preguntarle.
#
...
#
# LO QUE SE MIDIO EL 2026-09-07 CON ESTE MISMO LANZAMIENTO
# --------------------------------------------------------
...
node \"\$COORD_HOME/scripts/notify.mjs\" 'esq-2d: barrido terminado (5 brazos x $EPOCAS epocas). Resultados en nn/pesos/*/metrics.jsonl y muestras/*-ep$EPOCAS.png' || true"
